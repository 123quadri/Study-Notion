...
exports.capturePayment = async (req,res) => {
    ...
    if(courses.length === 0)
    {
        return res.json({success:true,message:"Please provide course ID"});
    }
    ...
    for( const course_id of courses)
    {
        ...
        try {
            ...
            if(!course)
            {
                return res.status(200).json({success:false,message:"Couldnt find the course"});
            }    
            ...
            // console.log("Error in capture payment1 : " , error);
...
exports.verifyPayment = async (req,res) => {
    ...
    if(!razorpay_order_id ||
        ...
        !razorpay_signature || !courses || !userId) {
            // console.log("Error in varifyPayment 1");
    ...
    const expectedSignature = crypto
        ...
        if(expectedSignature === razorpay_signature) {
            ...
            // console.log("Error in varifyPayment 2");
...
const enrollStudents = async(courses, userId, res) => {
    ...
    for(const courseId of courses) {
        ...
        //console.log("Email Sent Successfully", emailResponse.response);
            ...
            // console.log("Error in enrollelStudents 2" ,error);
            return res.status(500).json({success:false, message:error.message});
        }
    }
