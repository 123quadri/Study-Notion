...
const Footer = () => {
  return (
    <div className="bg-richblack-800 mt-[4rem]">
              ...
              <div className="flex flex-col gap-2">
                {["About", "Careers", "Affiliates"].map((ele, i) => {
                  return (
                    ...
                    >
                    {
                      ele === "About" ? (<Link to={`/${ele.toLowerCase()}`}>{ele}</Link>) :
                         ( <p>{ele}</p> )
                    }
          ...
          <div className="flex flex-row">
            {BottomFooter.map((ele, i) => {
              return (
                ...
                >
                {
                  ele !== "Cookie Policy" ? ( <Link to={`/${ele.split(" ").join("-").toLocaleLowerCase()}`}>
                    {ele}
                  </Link>) : 
                      (
                        <p>{ele}</p>
