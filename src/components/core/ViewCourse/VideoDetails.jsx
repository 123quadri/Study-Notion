...
import { sendSummarizationRequest } from "../../../services/operations/ai";
              ...
              <div className="mt-10 flex min-w-[250px] justify-center gap-x-4 text-xl">
                {!isFirstVideo() && (
                  <button
                    ...
                    bg-richblack-800 rounded-md px-[16px] py-[8px] text-[16px]
                    "
                  >
                    Prev
                  </button>
                ...
                {!isLastVideo() && (
                  <button
                    ...
                    className="bg-richblack-800 rounded-md px-[16px] py-[8px] text-[16px]"
                  >
                    Next
                  </button>
                )}
